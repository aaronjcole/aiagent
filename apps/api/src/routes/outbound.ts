...
/** Register the outbound routes: start an outbound sequence and list sequences. */
export function registerOutboundRoutes(app: FastifyInstance, ctx: AppContext): void {
  // POST /outbound — start the outbound sequence workflow for a prospect/sequence.
  ...
  // GET /sequences — list outreach sequences (with their steps).
